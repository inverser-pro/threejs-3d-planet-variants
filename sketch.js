...
/*    const bbox=new THREE.BoxGeometry(.5,.5);
    ...
    if (userAgent.match(/iPad/i) || userAgent.match(/iPhone/i)) {
        ...
        controls.minPolarAngle=controls.maxPolarAngle=1.225
...
/*            const txt7=createText('Jabascribt',[.422,1.105,.142],[0,1.2,0],.03,font);
            ...
            const txt7=createText('Jabascribt',[.56,.89,.49],[0,1.2,0],.03,font);
            ...
            const txt12=createText('USA',[-.2,.84,.69],[0,-.4,0],.03,font,0x84B3DF);
                ...
                const txt13=createText('Freedom',[.245,.46,-.968],[0,3.1,0],.03,font);
            ...
            const txt15=createText('Labtob',[.52,.11,-.915],[0,2.6,0],.03,font);
