...
camera.position.set(9,6,-3.5);
    /*dir test*///camera.position.set(0,10,0);
    ...
    /*hong*/
    createCurve({q:[-.3461,.4278,-.9060],w:[.6,1,-1.5],e:[.7,.8,-.5],r:[.652,.765,-.27]})
    /*lond*/
    createCurve({q:[.4278,.9060,.13],w:[.4,1,.2],e:[.8,1,0],r:[.652,.765,-.27]})
    /*singapug*/
    createCurve({q:[-.6921,-.2139,-.7738],w:[-.5,1.2,-1.2],e:[.5,1.2,-.7],r:[.652,.765,-.27]})
    /*usa*/
    createCurve({q:[.2139,.7738,.6921],w:[.5,1.2,.4],e:[.2,1.2,.4],r:[.652,.765,-.27]})
    /*usa2*/
    createCurve({q:[-.2139,.7738,.6921],w:[.7,.7,1],e:[.8,1,.7],r:[.652,.765,-.27]})
    /*lux*/
    createCurve({q:[.6,.792,-.13],w:[.7,.8,-.2],e:[.6,1,-.25],r:[.652,.765,-.27]})
